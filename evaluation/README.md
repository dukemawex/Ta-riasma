...
Claude calls use the standard **Anthropic SDK**. Gemini embeddings (default: `text-embedding-004`) can run either directly via Gemini SDK (`google-genai`) or via AgentRouter's OpenAI-compatible endpoint.
