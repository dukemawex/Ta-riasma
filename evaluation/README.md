...
Claude calls use the standard **Anthropic SDK**. Gemini embeddings (default model order: `text-embedding-004`, then `gemini-embedding-2`) can run either directly via the **google-genai SDK** or via AgentRouter's OpenAI-compatible endpoint.
